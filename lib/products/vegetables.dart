    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: <Widget>[
          ...
          // ProductItem(filter: filter, label: 'Carrots (pcs)', notifyParent: refresh),
          ProductItem(filter: filter, label: 'Potatoes (10g)', notifyParent: refresh),
          // ProductItem(filter: filter, label: 'Tomatoes (pcs)', notifyParent: refresh),
          ...
          ProductItem(filter: filter, label: 'Lettuce (10g)', notifyParent: refresh),
          // ProductItem(filter: filter, label: 'Cucumber (pcs)', notifyParent: refresh),
          ProductItem(filter: filter, label: 'Brocolli (10g)', notifyParent: refresh),
